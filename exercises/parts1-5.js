...
var Spacecraft = /** @class */ (function () {
    ...
    Spacecraft.prototype.getDaysToLoction = function (kilometersAway) {
...
console.log("".concat(spaceShuttle, " will take ").concat(spaceShuttle.getDaysToLoction(kilometersToMars), " to get to mars."));
console.log("".concat(spaceShuttle, " will take ").concat(spaceShuttle.getDaysToLoction(kilometersToTheMoon), " to get to the moon."));
